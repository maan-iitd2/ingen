...
//  persistence (per DESIGN.md §8): configs created/edited here survive reloads. YAML import/export
//  delegate to the real serializers, and validation to the pure model validator — so the only thing
//  "mock" about this adapter is the storage backend. Replacing it with an HttpAdapter that calls the
//  FastAPI wrapper requires no change to callers.
