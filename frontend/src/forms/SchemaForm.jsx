...
//  forms are data, not bespoke JSX. Adding a backend field later = add a descriptor entry. This is
//  the "schema-driven forms" approach from DESIGN §4/§8.2 and the main defense against form
//  duplication.
//
