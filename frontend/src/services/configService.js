...
//
//  The adapter-agnostic contract for persisting and translating config documents. Today a
//  localStorage-backed MockAdapter satisfies it; tomorrow an HttpAdapter calling the FastAPI
//  wrapper satisfies the SAME signatures. UI code depends only on this interface, so swapping
//  adapters touches nothing in the components.
//
