...
//
//  Persists completed RunRecords for the Execution History view. Mock adapter uses localStorage;
//  a future HTTP adapter would call the wrapper's runs endpoint. Same signatures.
