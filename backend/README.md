...
The frontend dev server (Vite, port 5173) is allowed via CORS by default.
...
| `INGEN_CORS_ORIGINS` | `http://localhost:5173,http://127.0.0.1:5173` | Comma-separated allowed origins. |
